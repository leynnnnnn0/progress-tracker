    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <!-- The key fix is here - we put the main target and first subtarget in the same row -->
                    <td rowspan="{{ count($target['sub_targets']) }}">
                        {{ $target['description'] }}
                    </td>

                    <!-- First subtarget is in the same row as the main target -->
                ...
                <!-- Starting from the second subtarget -->
